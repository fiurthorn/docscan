...
class DocumentTypesScreen extends BaseScreen {
  ...
  @override
  State<DocumentTypesScreen> createState() => _DocumentTypesState();
...
class _DocumentTypesState extends TemplateBaseScreenState<DocumentTypesScreen, ItemBloc> {
  @override
          ...
          child: Column(
            ...
            children: [
              ListView.builder(
                ...
                itemCount: formBloc.main.documentTypes.value.length,
                itemBuilder: (context, index) => TextFieldBlocBuilder(
                  textFieldBloc: formBloc.main.documentTypes.value[index],
                  autofocus: index == formBloc.main.documentTypes.value.length - 1,
